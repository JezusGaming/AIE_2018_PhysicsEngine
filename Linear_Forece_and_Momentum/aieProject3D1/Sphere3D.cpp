...
Sphere3D::Sphere3D(glm::vec3 position, glm::vec3 velocity, float mass, float radius, glm::vec4 colour) : Rigidbody3D(SPHERE, position, velocity, 0, mass, 0.2f, 0.2f, 0.8f)
{
	m_radius = radius;
	m_colour = colour;
}
